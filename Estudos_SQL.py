...
# = ("INSERT INTO Cadastro_de_Entregas (id, Loja, Destinatário, Telefone, UF, Município, Bairro, Número, Endereço, CEP, Complemento, Data_Limite, Data_da_Carga, Volumes, Valor_NF) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)")
...
#cursor.execute("CREATE TABLE Cadastro_de_Entregas_Diario (id TEXT NOT NULL PRIMARY KEY, Loja INTEGER, Destinatário VARCHAR(25), Telefone TEXT, UF TEXT, Município VARCHAR(25), Bairro VARCHAR(25), Número INTEGER, Endereço VARCHAR(250), CEP TEXT, Complemento TEXT, Data_Limite TEXT, Data_da_Carga TEXT, Volumes INTEGER, Valor_NF TEXT)")
banco_de_dados = ("INSERT INTO Cadastro_de_Entregas_Diario (id, Loja, Destinatário, Telefone, UF, Município, Bairro, Número, Endereço, CEP, Complemento, Data_Limite, Data_da_Carga, Volumes, Valor_NF) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)")
valores = [id, loja, destinatario, telefone, uf, municipio, bairro, numero, endereco, cep, complemento, data_limite, data_da_carga, volumes, valor_nf]
